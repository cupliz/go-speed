...
export default class AddaRatingOnShipper1 extends Component {
    render() {
        return (
            <Container>
                <Content padder >
                    ...
                    <Text style={{ fontSize: 14, marginBottom: 10 }}>kindly provide go speed with your rating and feedback with <Text style={{ fontWeight: '500' }}>shipper 1</Text></Text>
